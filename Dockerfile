# MAINTAINER Kuldeep Pisda <pisdak79@gmail.com>
# Source and Inspiration: https://www.caktusgroup.com/blog/2017/03/14/production-ready-dockerfile-your-python-django-app/

FROM python:3.9-slim-buster

ARG APP_USER=kdpisda
...
# ENV DJANGO_SETTINGS_MODULE=essenvia.settings.deploy

# Call collectstatic (customize the following line with the minimal environment variables needed for manage.py to run):
# RUN DATABASE_URL='' python manage.py collectstatic --noinput

# Tell uWSGI where to find your wsgi file (change this):
ENV UWSGI_WSGI_FILE=essenvia/wsgi.py
